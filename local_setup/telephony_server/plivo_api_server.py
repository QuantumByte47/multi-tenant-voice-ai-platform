...
async def make_call(request: Request):
    try:
        ...
        call = plivo_client.calls.create(
            ...
            answer_url=f"{telephony_host}/plivo_connect?voice_agent_framework_host={voice_agent_framework_host}&agent_id={agent_id}",
...
async def plivo_connect(request: Request, voice_agent_framework_host: str = Query(...), agent_id: str = Query(...)):
    try:
        ...
        '''.format(voice_agent_framework_websocket_url)
